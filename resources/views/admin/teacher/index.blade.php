                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('create.teacher')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input name="name" class="form-control" id="inputName" type="text" placeholder="Full name" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input name="mobile" class="form-control" id="inputPassword" type="number" placeholder="Mobile" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <textarea name="address" class="form-control" id="inputAddress" type="text" placeholder="Address"></textarea>
