...
{{--                ==================Here is body section==================--}}
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                <div class="mb-2">
                    <img src="{{'/'}}admin/assets/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="">
                </div>
                ...
                <div class="mb-2">
                    <img src="{{'/'}}admin/assets/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="">
                </div>
                <div class="custom-control custom-switch mb-3">
                ...
                <div class="mb-2">
                    <img src="{{'/'}}admin/assets/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="">
                </div>
